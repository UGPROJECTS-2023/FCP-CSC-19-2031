						...
						<?php
						 ...
						 <tr>
						 	...
						 	<td>
						 		...
						 		<p><small>Total Paid Amount :<b><?php echo number_format(($sum_paid),2) ?></small></b></p>
						 		<p><small>Amount :<b><?php echo $row['amount'] ?></small></b></p>
						 		<p><b style="color: red">Total Balance :<b><?php echo number_format(($monthly * $plan_arr[$row['plan_id']]['months']-$sum_paid),2) ?></b></b></p>
